...
use endpoint_sec_sys::es_event_od_enable_user_t;
...
impl_debug_eq_hash_with_functions!(EventOdEnableUser<'a> with version; instigator, instigator_token, error_code, user_name, node_name, db_path);
