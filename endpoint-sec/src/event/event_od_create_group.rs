...
use endpoint_sec_sys::es_event_od_create_group_t;
...
impl_debug_eq_hash_with_functions!(EventOdCreateGroup<'a> with version; instigator, instigator_token, error_code, group_name, node_name, db_path);
