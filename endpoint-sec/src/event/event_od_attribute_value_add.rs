...
use endpoint_sec_sys::{es_event_od_attribute_value_add_t, es_od_record_type_t};
...
impl_debug_eq_hash_with_functions!(EventOdAttributeValueAdd<'a> with version; instigator, instigator_token, error_code, record_type, record_name, attribute_name, attribute_value, node_name, db_path);
