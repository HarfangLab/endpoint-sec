...
///
/// It is guaranteed that the ES provided cdhash value matches the binary
...
ffi_wrap_enum!(
    /// Represents the type of TCC modification event.
...
#[cfg(feature = "macos_15_4_0")]
ffi_wrap_enum!(
    /// Represents the identity type of an application which has access to a TCC
    /// service.
